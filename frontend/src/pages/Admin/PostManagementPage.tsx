                ...
                <Box>
                  ...
                  >
                    ...
                    {selectedPost.updatedAt &&
                      ` (Cập nhật: ${formatDate(selectedPost.updatedAt)})`}
                  </Typography>
                </Box>
              </Box>
                ...
                <Box sx={{ mt: 3, mb: 2 }}>
                  ...
                  <Paper variant="outlined" sx={{ p: 2 }}>
                    <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
                      <Avatar
                        src={selectedPost.originalPost.user.avatar || ""}
                        sx={{ width: 32, height: 32, mr: 1 }}
                      />
                      <Box>
                        <Typography variant="subtitle2">
                          {selectedPost.originalPost.user.lastName}{" "}
                          {selectedPost.originalPost.user.firstName}
                        </Typography>
                        <Typography variant="caption" color="text.secondary">
                    ...
                    {selectedPost.originalPost.images &&
                      selectedPost.originalPost.images.length > 0 && (
                        <Box
                          component="img"
